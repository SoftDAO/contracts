...
import "../../interfaces/IPriceTierVestingL2SequencerCheck.sol";
import "../../interfaces/IOracleWithSequencerCheck.sol";

abstract contract PriceTierVestingL2SequencerCheck is AdvancedDistributor, IPriceTierVestingL2SequencerCheck {
	...
	IOracleWithSequencerCheck private oracle; // oracle providing prices
	...
	function getOracle() external view override returns (IOracleWithSequencerCheck) {
		return oracle;
	}
