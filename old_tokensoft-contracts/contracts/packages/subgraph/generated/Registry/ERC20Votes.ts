...
export class ERC20Votes__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class ERC20Votes extends ethereum.SmartContract {
  static bind(address: Address): ERC20Votes {
    return new ERC20Votes("ERC20Votes", address);
  }
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): ERC20Votes__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<ERC20Votes__checkpointsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<ERC20Votes__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<ERC20Votes__checkpointsResultValue0Struct>(value[0].toTuple())
    );
  }
