...
contract TrancheVestingMerkleInitializable is Initializable, TrancheVestingInitializable, MerkleSetInitializable {
    function __TrancheVestingMerkle_init(
        ...
        __TrancheVesting_init(
            _token, _total, _uri, _tranches, _maxDelayTime, uint160(uint256(_merkleRoot)), _owner
        );
    ...
    return 'TrancheVestingMerkleInitializable';
  }
