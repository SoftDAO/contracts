...
export class SaleManager_v_1_2 extends ethereum.SmartContract {
  static bind(address: Address): SaleManager_v_1_2 {
    return new SaleManager_v_1_2("SaleManager_v_1_2", address);
  }
  ...
  newSale(
    ...
    let result = super.call(
      "newSale",
      "newSale(address,bytes32,uint256,uint256,uint256,uint256,uint160,string,uint256,uint8):(bytes32)",
      [
