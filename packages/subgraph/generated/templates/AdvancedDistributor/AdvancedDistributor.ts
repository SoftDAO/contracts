...
export class AdvancedDistributor__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class AdvancedDistributor__getDistributionRecordResultValue0Struct extends ethereum.Tuple {
...
export class AdvancedDistributor extends ethereum.SmartContract {
  static bind(address: Address): AdvancedDistributor {
    return new AdvancedDistributor("AdvancedDistributor", address);
  }
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): AdvancedDistributor__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<AdvancedDistributor__checkpointsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<AdvancedDistributor__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<AdvancedDistributor__checkpointsResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getDistributionRecord(
    beneficiary: Address
  ): AdvancedDistributor__getDistributionRecordResultValue0Struct {
    let result = super.call(
      "getDistributionRecord",
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<AdvancedDistributor__getDistributionRecordResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
