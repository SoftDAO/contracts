...
import { NewSale } from "../../../generated/FlatPriceSaleFactory_v_4_0/FlatPriceSaleFactory_v_4_0";
import { getOrCreateAccount, getOrCreateNativePaymentMethod } from "../../lib";
import { SaleImplementation, Sale } from "../../../generated/schema";
import { FlatPriceSale_v_4_0 } from "../../../generated/templates";
...
export function handleNewSale(event: NewSale): void {
  FlatPriceSale_v_4_0.create(event.params.clone);
  ...
  sale.paymentMethods = event.params.nativePaymentsEnabled
    ? [
        getOrCreateNativePaymentMethod(event.params.nativeOracle, event.block)
          .id
      ]
    : [];
