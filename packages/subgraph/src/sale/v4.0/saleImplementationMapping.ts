...
import { SaleImplementation } from "../../../generated/schema";
import { log, BigInt } from "@graphprotocol/graph-ts";

export function handleImplementationConstructor(
  ...
  if (versionResult.reverted) {
    log.error("could not call VERSION() on implementation at {} in tx {}", [
      saleImplementationId,
