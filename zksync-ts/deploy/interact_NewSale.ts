...
const addressesDatabase = {
  ...
  zkSync: {
    ethOracleAddress: "0x6D41d1dc818112880b40e26BD6FD347E41008eDA",
    usdcAddress: "FILL_ME_IN",
    usdcOracleAddress: "FILL_ME_IN",
    flatPriceSaleFactoryAddress: {
      v2: "FILL_ME_IN",
      "v2.1": "FILL_ME_IN",
      v3: "FILL_ME_IN",
      unknown: "FILL_ME_IN",
      v4: "0xd14FE6459168bEFACDe8d9ee9305d9827Ab51709"
    }
  },
  zkSyncSepolia: {
    ethOracleAddress: "0x4aDC67696bA383F43DD60A9e78F2C97Fbbfc7cb1",
    ...
    flatPriceSaleFactoryAddress: {
      ...
      v3: "FILL_ME_IN",
      unknown: "FILL_ME_IN",
      v4: "0x8465C8ca6d1b8EDF7444d5E4BB9b45e1F35b1D02"
    }
  }
};
...
const configsDatabase = {
  v1: {
    ...
    merkleRoot:
      "0x38e08c198f919ebfa9a16d4e54821b360241e6a43aac9e9845dfcd3f85153433",
    ...
    endTime: Math.floor(
      new Date(new Date().getTime() + 10 * 24 * 3600 * 1000).getTime() / 1000
    ),
...
export default async function () {
  const FlatPriceSaleFactory_v_4_0Artifact = await hre.artifacts.readArtifact(
    "FlatPriceSaleFactory_v_4_0"
  );
  const FlatPriceSaleFactory_v_4_0 = new ethers.Contract(
    addressesDatabase[currentNetwork].flatPriceSaleFactoryAddress.v4,
    FlatPriceSaleFactory_v_4_0Artifact.abi,
    getWallet()
  );

  const transaction = await FlatPriceSaleFactory_v_4_0.newSale(
    ...argsDatabase[currentArgsVersion]
  );
